...
var API = {
    ...
    adminById: function (rid, success, error) {
        Get("/adminById", {rid: rid}, success, error);
    },
    opinion: function (params, success, error) {
        Get("/opinion", {
            currentPage: params.currentPage,
            pageSize: params.pageSize
        }, success, error);
    },
    delOpinion: function (rid, success, error) {
        Post("/delOpinion", {rid: rid}, success, error);
    },
    opinionById: function (rid, success, error) {
        Get("/opinionById", {rid: rid}, success, error);
    },
    saveOpinion: function (obj, success, error) {
        Post("/saveOpinion", obj, success, error);
    },
    updateOpinion: function (obj, success, error) {
        Post("/updateOpinion", {opinion: obj}, success, error);
    },
    book: function (params, success, error) {
        Get("/book", {
            currentPage: params.currentPage,
            pageSize: params.pageSize
        }, success, error);
    },
    updateBooking: function (obj, success, error) {
        Post("/updateBooking", {book: obj}, success, error);
    },
    delBooking: function (rid, success, error) {
        Post("/delBook", {rid: rid}, success, error);
    },
    emergency: function (params, success, error) {
        Get("/emergency", {
            currentPage: params.currentPage,
            pageSize: params.pageSize
        }, success, error);
    },
    delEmergency: function (rid, success, error) {
        Post("/delEmergency", {rid: rid}, success, error);
    },
    emergencyById: function (rid, success, error) {
        Get("/emergencyById", {rid: rid}, success, error);
    },
    surveyGroup: function (success, error) {
        Get("/surveyGroup", success, error);
    },
    questionList: function (param, success, error) {
        Get("/questionList", param, success, error);
    },
    questionById: function (rid, success, error) {
        Get("/questionById", {rid:rid}, success, error);
    },
    questionCalc: function (param, success, error) {
        Get("/questionCalc", param, success, error);
    },
    saveQuestion: function (param, success, error) {
        Post("/saveQuestion", param, success, error);
    },
    delQuestion: function (rid, success, error) {
        Post("/delQuestion", {questionId:rid}, success, error);
    },
    delQuestionGroup: function (rid, success, error) {
        Post("/delQuestionGroup", {groupId: rid}, success, error);
    },
    addGroup: function (obj, success, error) {

...
var MESSAGE_URL="http://"+serverConfig.host+"/weixin/access";

exports.sendEmergencyTemplateMessage=function(domainId,from,to,toOpenid,number,type){
    if(toOpenid&&toOpenid.length>0){
        var templateId=serverConfig.emergencyMessageTemplate;
        var messageUrl="http://"+serverConfig.host+"/app/weixin/access?folder=wegov&page=2.2xinxikuaibao&domain="+domainId;
        var title="";
        if(type==1){
...
exports.sendEmergencyReturnTemplateMessage=function(domainId,from,to,toOpenid,reason){
    if(toOpenid&&toOpenid.length>0) {
        var templateId = serverConfig.emergencyMessageTemplate;
        var messageUrl = "http://" + serverConfig.host + "/app/weixin/access?folder=wegov&page=2.1xinxikuaicai&domain=" + domainId;
